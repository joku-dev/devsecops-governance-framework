...
def schema_validator(kind: str) -> Draft202012Validator:
    require(kind in (*KINDS, "profile", "transaction", "index", "decision-v0.2", "remediation-v0.2", "action-transaction", "action-index", "closure-v0.2", "closure-transaction", "closure-index", "exception", "exception-profile", "exception-transaction", "exception-index", "event-v0.2", "overview", "candidate-context", "candidates", "devsecops-source", "architecture-source", "pilot-role-binding", "live-profile-preparation", "pilot-operating", "pilot-receipt", "personal-channel-probe", "pilot-action-request", "pilot-action-receipt", "operating-acceptance"), "Unknown lifecycle schema kind")
    resources = []
