...
| Inspect refreshed consumer evidence and the first proposed consumer lifecycle case | `docs/operations/reference-runs/2026-09-13-consumer-revalidation.md`, `docs/operations/evidence/consumer-lifecycle-operation-readiness.md` (prepared; scope/roles/evidence approval pending) |
