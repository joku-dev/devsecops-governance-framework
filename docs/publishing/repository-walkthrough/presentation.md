...
Stand: 11. September 2026. Ausgabe 1.1. Quellstand: `4abe88294f299d7f801c74ff0161df234960c092`.

Vorgesehene Vortragsdauer: etwa 20 Minuten.

## Folie 1: Wie das Repository arbeitet
...
## Folie 2: Der vollständige Governance-Ablauf
...
## Folie 3: Zwei Repositories mit klaren Aufgaben

Das Governance-Repository liefert Regeln. Das Anwendungs-Repository liefert Nachweise.

- **Governance-Repository:** Quellen und Modelle pflegen
Baselines veröffentlichen
Ergebnisse aufnehmen und anzeigen

- **Anwendungs-Repository:** Anwendung bauen und prüfen
Nachweise einem Lauf zuordnen
Governance-Workflows ausführen
...
## Folie 4: Die wichtigsten Bereiche im Repository
...
## Folie 5: Aufnahme und Änderung von Vorgaben
...
## Folie 6: Eine Anforderung als ausführbare Kontrolle
...
Quellen: [3](https://github.com/joku-dev/devsecops-governance-framework/blob/4abe88294f299d7f801c74ff0161df234960c092/model/controls/dscb-l1.yaml), [4](https://github.com/joku-dev/devsecops-governance-framework/blob/4abe88294f299d7f801c74ff0161df234960c092/policies/opa/sbom_required.rego)

## Folie 7: Die SBOM-Prüfung im Detail
...
| exists = true<br>linked_to_artifact = false | Befund: Die Zuordnung zum Artefakt fehlt. |
| exists = true<br>linked_to_artifact = true | Kein SBOM-Befund aus dieser Regel. |
...
Quellen: [4](https://github.com/joku-dev/devsecops-governance-framework/blob/4abe88294f299d7f801c74ff0161df234960c092/policies/opa/sbom_required.rego)

## Folie 8: Baselines legen den Prüfstand fest

Eine Anwendung bezieht sich auf einen veröffentlichten, identifizierbaren Regelsatz.

- **DevSecOps L1:** l1-baseline-v1.1.3
Kontrollen und Nachweise für den Software-Lieferprozess

- **Architecture L1:** architecture-baseline-l1-v0.1.0
Architekturmodell und Prüfungen zur Einsatzbereitschaft
...
## Folie 9: Ausführung in der Anwendung
...
Quellen: [7](https://github.com/joku-dev/devsecops-governance-framework/blob/4abe88294f299d7f801c74ff0161df234960c092/.github/workflows/architecture-baseline-l1-v0.1.0.yml)

## Folie 10: DevSecOps und Architektur prüfen andere Fragen

Die beiden Domänen ergänzen sich und behalten eigene Ergebnisse.

- **DevSecOps:** Wie entstehen Software und Nachweise?
Beispiele: Branch-Schutz, SBOM, Schwachstellen und Artefaktintegrität.

- **Architektur:** Welche Voraussetzungen erfüllen Entwurf und Betrieb?
Gates: Architecture, Integration, Release und Operation Readiness.
...
## Folie 11: Die Aufnahme eines Ergebnisses
...
## Folie 12: Ergebnisgeschichte und aktuelle Übersicht
...
Quellen: [6](https://github.com/joku-dev/devsecops-governance-framework/blob/4abe88294f299d7f801c74ff0161df234960c092/docs/operations/evidence/governance-result-intake-and-viewer-usage.md)

## Folie 13: Drei getrennte Signale im Viewer
...
## Folie 14: Report-only und Blocking

Der Ausführungsmodus bestimmt die technische Reaktion auf Befunde.

- **Report-only:** Befunde erscheinen im Bericht.
Technische Fehler können den Lauf dennoch stoppen.

- **Blocking:** Relevante Befunde lassen den Lauf scheitern.
Branch-Schutz entscheidet über die Wirkung auf einen Merge.
...
## Folie 15: Fehlerbehandlung und täglicher Betrieb
...
## Folie 16: Ein Ergebnis bis zur Quelle erklären
